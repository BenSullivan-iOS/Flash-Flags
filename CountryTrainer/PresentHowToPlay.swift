...
class PresentHowToPlay: NSObject, UIViewControllerAnimatedTransitioning {
  ...
  func createToView(_ trans: UIViewControllerContextTransitioning) -> UIView {
    ...
    toView.frame = CGRect(x: 0, y: 0, width: trans.containerView.bounds.width - 10, height: trans.containerView.bounds.height - 50)
